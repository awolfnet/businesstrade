...
public class MerchantListAdapter extends BaseAdapter{
    ...
    private MerchantListModel merchantList=null;

    public MerchantListAdapter(Context context, MerchantListModel marketList)
    {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_merchant_contact.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                MerchantModel merchantInfo=merchantList.get(merchant_index);
