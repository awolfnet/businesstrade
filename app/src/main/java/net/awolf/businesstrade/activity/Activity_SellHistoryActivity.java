...
public class Activity_SellHistoryActivity extends TAActivity {
    private final String TAG="Activity_SellHistoryActivity";
    ...
    @TAInjectView(id = R.id.lv_sellhistory_list)
    private ListView lvSellHistory;
    ...
    private static Activity_SellHistoryActivity instance=null;
    public static Activity_SellHistoryActivity getInstance() {
        return instance;
    }
    ...
    private void showCargoOrderHistoryList()
    {
        ...
        Method.getInstance().getSellCargoHistoryList(userToken, new IMethodCallback() {
            @Override
            public void onSuccesse(Object o) {
                Context context=Activity_SellHistoryActivity.getInstance();
                CargoOrderHistoryListAdapter cargoListAdapter=new CargoOrderHistoryListAdapter(context, (CargoOrderHistoryListModel) o);
                lvSellHistory.setAdapter(cargoListAdapter);
            }
    ...
    {
        Method.getInstance().getSellHistoryList(userToken, new IMethodCallback() {
            @Override
            public void onSuccesse(Object o) {
                Context context=Activity_SellHistoryActivity.getInstance();
                OrderHistoryListAdapter orderHistoryListAdapter= new OrderHistoryListAdapter(context, (OrderHistoryListModel) o);
                lvSellHistory.setAdapter(orderHistoryListAdapter);
            }
